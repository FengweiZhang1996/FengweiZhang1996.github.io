/* Fengwei Zhang's tic tac toe game page's javascipt
[IMPORTANT]
...
function begin_play()
{
	...
	else if(isEmpty(document.getElementById("player1_id").value) == true || isEmpty(document.getElementById("player2_id").value) == true)
	{
...
function reset_play()
{
	...
	for(i = 0; i < board_state.length; i = i + 1)
	{
		board_state[i] = -1;
	}
}
...
function play()
{
	...
	else if(table_ids.includes(document.getElementById("move_text_id").value) == false)
	{
		alert("Invalid move! The cell is non-existant.");
	}
	else
	{
		if(board_state[table_ids.indexOf(document.getElementById("move_text_id").value)] != -1)
		{
			alert("Invalid move! The cell is occupied.");
		}
		else if(turn == 1)
		{
			turn = 0;
		...
		if((board_state[0] == 1 && board_state[0] == board_state[1] && board_state[0] == board_state[2]) ||
			(board_state[3] == 1 && board_state[3] == board_state[4] && board_state[3] == board_state[5]) ||
			(board_state[6] == 1 && board_state[6] == board_state[7] && board_state[6] == board_state[8]) ||
			(board_state[0] == 1 && board_state[0] == board_state[3] && board_state[0] == board_state[6]) ||
			(board_state[1] == 1 && board_state[1] == board_state[4] && board_state[1] == board_state[7]) ||
		 	(board_state[2] == 1 && board_state[2] == board_state[5] && board_state[2] == board_state[8]) ||
			(board_state[0] == 1 && board_state[0] == board_state[4] && board_state[0] == board_state[8]) ||
			(board_state[2] == 1 && board_state[2] == board_state[4] && board_state[2] == board_state[6])){
				alert("Winner is: O");
				reset_play();
			}
			else if((board_state[0] == 0 && board_state[0] == board_state[1] && board_state[0] == board_state[2]) ||
				(board_state[3] == 0 && board_state[3] == board_state[4] && board_state[3] == board_state[5]) ||
				(board_state[6] == 0 && board_state[6] == board_state[7] && board_state[6] == board_state[8]) ||
				(board_state[0] == 0 && board_state[0] == board_state[3] && board_state[0] == board_state[6]) ||
				(board_state[1] == 0 && board_state[1] == board_state[4] && board_state[1] == board_state[7]) ||
			 	(board_state[2] == 0 && board_state[2] == board_state[5] && board_state[2] == board_state[8]) ||
				(board_state[0] == 0 && board_state[0] == board_state[4] && board_state[0] == board_state[8]) ||
				(board_state[2] == 0 && board_state[2] == board_state[4] && board_state[2] == board_state[6])){
					alert("Winner is: X");
					reset_play();
			}
			else if(board_state[0] != -1 && board_state[1] != -1 && board_state[2] != -1 &&
