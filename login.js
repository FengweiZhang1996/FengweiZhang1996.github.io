function openModal() {
	...
	myInput.onkeyup = function() {
       console.log('helllooo')
        ...
        var LowerCaseL = /[a-z]/g; //Experssion for lowerCaseLetters

        var UpperCaseL = /[A-Z]/g; //Experssion for upperCaseLetters

        var Nums = /[0-9]/g; // Digits/numbers
        
        var MinL = 8; //The minimum length to be used in question
        ...
        if(myInput.value.match(LowerCaseL)) 
        {
        ...
        if(myInput.value.match(UpperCaseL)) 
        {
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var mIv = myInput.value;
                var cMi = confirmMyInput.value; 
                if(mIv==cMi)
                {
...
//This is used to check requirment
